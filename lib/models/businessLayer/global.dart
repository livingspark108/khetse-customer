...
Future<Map<String, String>> getApiHeaders(bool authorizationRequired) async {
  ...
  if (authorizationRequired) {
    ...
    if (sp!.getString("currentUser") != null) {
      ...
      print("TOKEN FROM getApiHeaders() = ${currentUser.token}");
      currentUser.token != null ? apiHeader.addAll({"Authorization": "Bearer " + currentUser.token!}) : null;
    }
  }
