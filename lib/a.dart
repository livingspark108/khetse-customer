...
'instance_id' => '68E946D9EDC43',
'access_token' => '68e9467b7449c'
];

try {
$response = Http::withHeaders([
'Content-Type' => 'application/json'
])->post('https://livingchat.in/api/send', $payload);
...
$message = array('status' => '0', 'message' => "Invalid OTP");
return $message;
}
