...
final class AllOrderHistoryList extends StatelessWidget {
  ...
  AllOrderHistoryList({this.analytics, this.observer, super.key}) {
...
final class PastOrderHistoryList extends StatelessWidget {
  ...
  PastOrderHistoryList({this.analytics, this.observer, super.key}) {
