...
class WishListScreen extends BaseRoute {
  WishListScreen({super.analytics, super.observer, super.routeName = 'WishListScreen'});
  @override
    ...
    try {
      showModalBottomSheet(
        ...
        builder: (context) => Padding(
            ...
            child: FilterScreen(
              _productFilter,
              isProductAvailable: _wishListProductList.length > 0 ? true : false,
            )),
      ).then((value) async {
        if (value != null) {
          _isDataLoaded = false;
          if (_wishListProductList.length > 0) {
            _wishListProductList.clear();
          }
