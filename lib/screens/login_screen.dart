...
class LoginScreen extends BaseRoute {
  LoginScreen({super.analytics, super.observer, super.routeName = 'LoginScreen'});
...
class _LoginScreenState extends BaseRouteState {
  ...
  login(String userPhone) async {
    try {
      ...
      hideLoader();
      print("Exception - login_screen.dart - login():" + e.toString()+"$stacktrace");
    }
  }
        ...
        case FacebookLoginStatus.success:
          ...
          if (result != null) {
            if ('${result['status']}' == '1') {
              ...
              CurrentUser _currentuser = new CurrentUser();
              _currentuser.email = email as String?;
            ...
            hideLoader();
            print("SHOWING TEXT = ${AppLocalizations.of(context)!.txt_please_try_again_after_sometime}");
            showSnackBar(
                key: scaffoldKey1,
                snackBarMessage:
