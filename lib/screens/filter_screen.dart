              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      "None",
                      style: _selectedDiscount == 0 ? Theme.of(context).textTheme.titleMedium!.copyWith(fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.primary) : Theme.of(context).textTheme.bodyLarge,
                    ),
                  ],
                ),
                Row(
    ...
    try {
      ...
      if (_selectedDiscount != null) {
        if (_selectedDiscount == 0) {
          productFilter.minDiscount = 0;
          productFilter.maxDiscount = 0;
        } else if (_selectedDiscount == 7) {
